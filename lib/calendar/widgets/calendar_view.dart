                              ...
                              Column(
                                children: [
                                  RadioListTile<EventDisplay>(
                                    title:
                                        Text(EventDisplay.all.getName(context)),
                                  ...
                                  RadioListTile<EventDisplay>(
                                    title:
                                        Text(EventDisplay.mine.getName(context)),
...
class _EventList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final privateEvents = events
        .where((e) => e.eventType == EventType.private)
        .toList();
    final preschoolEvents = events
        .where((e) => e.eventType == EventType.preschool)
        .toList();
    final otherEvents = events
        .where((e) =>
            e.eventType != EventType.free &&
            ...
            children: [
              ...
              if (privateEvents.isNotEmpty) ...[
                _SectionHeader(
                  ...
                  color: EventType.private.getColor(context),
                  icon: EventType.private.getIcon(context),
                ),
              ...
              if (otherEvents.isNotEmpty) ...[
                ...
                ...otherEvents.map((event) => _SingleEventCard(
                      event: event,
                      locale: locale,
                      firstDay: firstDay,
                      lastDay: lastDay,
