...
const termsOfUse = [
  '第 1 条（目的）',
  'このサクセス・アカデミー利用規約（以下「本規約」という）は、「サクセス・アカデミー」（以下「本会」という）の会員（以下「会員」という）が、合同会社MERCY（以下「当社」という）の運営するオンライン学習プログラム「サクセス・アカデミー」（以下「本サービス」という）を利用するに際して、その規則を定めたものとなります。',
  ...
  '本会の会員へ対する重要なお知らせは、当社より電子メールにて通知します。会員は、本会への入会と同時に、当該電子メールを受け取ることに予め承諾するものとします。',
  '第４条（本サービスの内容）',
  ...
  '第１１条（退 会）',
  'サービス期間を終了する場合は、自身でマイページからキャンセル手続きをする。なお、当社が既に受領した入会金、その他の金銭債務の払い戻し等はなされません。',
  ...
  '会員の退会後についても、個人情報を法令に従って取り扱い、保有する必要がなくなったものについては、速やかにこれを消去するものとします。',
  ...
  '本規約に関する準拠法は日本法とします。',
  '【別紙 1 】サービス内容について',
  '本規約第５条の定める本サービス及び費用は、別紙定める。',
  '・金額は変更のない限り毎月自動更新とし、変更時は事前告知をし、コース変更のタイミングで新料金へ変更いたします。',
  '【付則】会員に関する規定',
  '１．指導開始直前（2分程度前）に、Zoomにつなぎ指定されたIDのクラスに入っておくこと。',
  '２．個別指導で遅刻・欠席をする場合は、事前に必ず連絡すること。無料サポートも連絡願います。',
  '３．指導中は、テレビやゲーム、スマホをOFFにし、勉強に集中すること。ご家族も協力をお願いします。',
